...
matchTag = document.querySelector(".match b"),
...
function matchCards(icon1, icon2){
    if(icon1 === icon2){
        matchedCards++;
        matchTag.innerText = matchedCards;
...
function shuffleCards(){
    ...
    timeTag.innerText = timeLeft;
    flipsTag.innerText = flips;
    matchTag.innerText = matchedVal;
    disableDeck = isPlaying = false

    let arr = ["bxl-python", "bxl-javascript", "bxl-html5", "bxl-react", "bxl-mongodb", "bxl-nodejs", "bxl-python", "bxl-javascript", "bxl-html5", "bxl-react", "bxl-mongodb", "bxl-nodejs"];
